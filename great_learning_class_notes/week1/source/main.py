...
def HasARelationShipImplementation():
    ...
    # coral_card = CoralCard(coral_card_details)
    # First Style : Create an Instance of Coral Card and Pass that Instance in the below line..
    # with additional owner name

    # Second Style : Simple Implementation -
    # pass all attributes and internally create Coral Card as well.
