...
class Richtext:
    ...
    # This functions toggles between the bold and normal text
    ...
    def swap_italic_state(self, textarea, text_obj_lst):
        ...
        # since italic is common to all the fonts, it is important to get the status of all the fonts and
        # do a logical ro to get the actual italic status
        for i in range(len(text_obj_lst)):
            italic_state = italic_state or text_obj_lst[i].get_italic_state()
...
class ArialRichText(Richtext):
    ...
    def swap_bold_state(self, textarea, text_obj_lst):
        super().swap_bold_state(textarea, text_obj_lst)
        textarea.configure(
            font=("Arial", 18, text_obj_lst[0].get_bold_state() + " " + text_obj_lst[0].get_italic_state()))

    def swap_italic_state(self, textarea, text_obj_lst):
        super().swap_italic_state(textarea, text_obj_lst)
        textarea.configure(
            font=("Arial", 18, text_obj_lst[0].get_bold_state() + " " + text_obj_lst[0].get_italic_state()))


# class implements Courier fonts
class CourierNewRichText(Richtext):
    ...
    def swap_bold_state(self, textarea, text_obj_lst):
        # this is where the narrow hierarchy is applied. Only the varying part is specific
        super().swap_bold_state(textarea, text_obj_lst)
        # renders the text
        textarea.configure(
...
# class implements Times new Roman fonts
...
class MenuBar:
    def __init__(self, parent):
        ...
        # This code ties menu actions to corresponding events
...
class FileOperation:
    def __init__(self, master1):
        ...
        self.base_obj = self.rich_text = Richtext()
    ...
    # code that changes the font to arial
    def arial(self):
        self.rich_text = self.text_obj_lst[0]
        bold_state = ""
        italic_state = ""

        # changing the font should not change the bold or italics. So this code take care of that.
    ...
    # code that changes the font to courier
    ...
    # code that changes the font to Times new roman
